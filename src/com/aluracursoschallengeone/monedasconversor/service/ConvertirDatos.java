...
public record ConvertirDatos(String result, String documentation, String terms_of_use,
            ...
            public Double getConversion(String monedaPrincipal){
                return conversion_rates.get(monedaPrincipal);
            }
}
